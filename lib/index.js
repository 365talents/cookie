    ...
    const scheme = {
        authenticate: async (request, h) => {
            ...
            const validate = async () => {
                ...
                if (!session) {
                    return h.unauthenticated(Boom.unauthorized('Missing cookie', 'shared-cookie'));
                }
                ...
                try {
                    ...
                    if (!result.valid) {
                        return h.unauthenticated(Boom.unauthorized('Invalid session or cookie', 'shared-cookie'));
                    }
                    ...
                    return h.unauthenticated(unauthorized, { credentials, artifacts: session });
                }
            };
